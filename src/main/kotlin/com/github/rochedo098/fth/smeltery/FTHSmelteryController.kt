...
object FTHSmelteryController {
    class SBlock(settings: AbstractBlock.Settings): BlockWithEntity(settings) {
        init {
    ...
    class SEntity(pos: BlockPos, state: BlockState): BlockEntity(FabricSmith.SMELTERY_CONTROLLER_ENTITY, pos, state), ImplementedInventory {
